package
{
	...
	public class CelShadingShader extends ActionScriptShader
	{
		...
		private var _thickness	: SValue	= null;
		private var _isEdge		: SValue	= null;
		
		public function CelShadingShader(thickness : Number = DEFAULT_THICKNESS) : void
		{
		...
		override protected function getOutputPosition() : SValue
		{
			...
			var delta : SValue = multiply(_isEdge, vertexNormal.xyz, _thickness);
